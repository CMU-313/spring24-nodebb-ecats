...
describe('User', () => {
    ...
    describe('.create(), when created', () => {
        ...
        it('should be created properly', async () => {
            testInstructorUid = await User.create({ username: instructorData.username, password: instructorData.password, accounttype: 'instructor' });
